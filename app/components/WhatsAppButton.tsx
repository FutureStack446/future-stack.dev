...
export function WhatsAppButton() {
  // Cleans the phone number for the URL (removes spaces, +, etc)
  const cleanNumber = personalInfo.phone.replace(/[^0-9]/g, "");
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-[99] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/40 group"
